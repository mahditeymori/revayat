  ...
  return (
    <div>
      ...
      <p className="mt-2 text-xs text-ink-60">
        آمار بازدید بدون کوکی و بدون سرویس بیرونی جمع‌آوری می‌شود. شناسه بازدیدکننده هر روز عوض
        می‌شود، پس «بازدیدکننده» یعنی بازدیدکننده در آن روز. بازدید از پنل مدیریت ثبت نمی‌شود.
      </p>
